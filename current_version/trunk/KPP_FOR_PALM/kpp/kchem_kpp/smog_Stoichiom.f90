...
MODULE smog_Stoichiom

  USE smog_Parameters
  USE smog_StoichiomSP
...
! JVRP(10) = dARP(7)/dV(6)
  JVRP(10) = V(10)
! JVRP(11) = dARP(7)/dV(10)
  JVRP(11) = V(6)
! JVRP(12) = dARP(8)/dV(9)
  JVRP(12) = V(10)
! JVRP(13) = dARP(8)/dV(10)
  JVRP(13) = V(9)
! JVRP(14) = dARP(9)/dV(7)
  JVRP(14) = V(10)
...
! JVRP(16) = dARP(10)/dV(11)
  JVRP(16) = V(12)
! JVRP(17) = dARP(10)/dV(12)
  JVRP(17) = V(11)
! JVRP(18) = dARP(11)/dV(7)
  JVRP(18) = V(11)
! JVRP(19) = dARP(11)/dV(11)
  JVRP(19) = V(7)
