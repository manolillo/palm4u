...
! Former revisions:
! -----------------
! $Id: temperton_fft_mod.f90 1851 2016-04-08 13:32:50Z maronga $
!
...
#if defined( __nec )
    INTEGER(iwp), PARAMETER ::  nfft = 256  !< 
#else
    INTEGER(iwp), PARAMETER ::  nfft =  32  !< 
#endif
...
!    WRITE (nout,'(A,I4,A)') ' n =',n,' - Contains illegal factors'
    message_string = 'number of gridpoints along x or/and y ' // &
                     ...
                     '&only factors 8,6,5,4,3,2 are allowed' 
